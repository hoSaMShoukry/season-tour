                ...
                <form class="d-flex gap-4 flex-column">
                    ...
                    <div class="d-flex gap-3 flex-md-row flex-column">
                        <label class="w-100">
                            ...
                            <VueDatePicker v-model="searchInfo.departureDate" :min-date="new Date().toLocaleDateString('en-CA')"
                                ...
                                <tr class="rooms"
                                    ...
                                    <td>
                                        <select class="rounded-1 p-2 px-3 w-100" name="room type"
                                            ...
                                            <option value="child without bed">{{$t('programs.search.childWithoutBed')}}</option>
