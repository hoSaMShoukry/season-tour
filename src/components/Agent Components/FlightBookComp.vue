...
const bookingInfo = ref({
    ...
    agentDiscount: computed(() => (bookingInfo.value.total * userInfo.value.discount) / 100),
    net_total: computed(() => ((parseFloat(bookingInfo.value.total) + ((bookingInfo.value.tax / 100) * parseFloat(bookingInfo.value.total))) - bookingInfo.value.agentDiscount)),
})
