        ...
        <div class="container">
            <div class="login-box p-4 rounded-1 bg-white mx-auto">
                ...
                <form class="d-flex flex-column gap-3 mt-4">
                    <img width="250" height="250" style="object-fit: cover;" class="rounded-circle mx-auto mt-5" v-if="imgPreview !== ''" :src="imgPreview" alt="">
                    ...
                    <label>
                        ...
                        <span v-if="validation.password.$error" class="error text-danger fst-italic d-block w-100">
                            {{ validation.password.$errors[0].$validator === 'required' ? 'Field Required' : 'Please Confirm Password' }}
                        </span>
                    </label>
                    <label>
                        ...
                        <span v-if="validation.confirmPassword.$error" class="error text-danger fst-italic d-block w-100">
                            {{ validation.confirmPassword.$errors[0].$validator === 'required' ? 'Field Required' : 'Please Confirm Password' }}
                        </span>
                    </label>
                    <button class="butn p-2 px-3 rounded-1 mt-4 text-uppercase"
                        @click.prevent="submission">{{ $t('buttons.signup') }}</button>
                </form>
